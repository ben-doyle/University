...
public class Allocator {
     ...
     * 
     * @require allocation!=null && the keys in allocation are not null and
     *           each event in keySet of allocation maps to a non-null venue
     *           that can host that event.
     * @ensure returns the traffic caused by the given allocation.
     */
     ...
     *           each event in keySet of allocation maps to a non-null venue
     *           that can host that event.
     * @ensure returns whether or not the traffic in the given allocation is
     *          safe.
     */

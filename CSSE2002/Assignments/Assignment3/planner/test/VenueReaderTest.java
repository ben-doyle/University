...
public class VenueReaderTest {
    ...
    /**
     * Test for checking incorrect file name
     */
    @Test(expected = IOException.class)
    public void test01IOException() throws IOException, FormatException {
        VenueReader.read("wrongfilename.txt");
    }
     ...
     */
    @Test
    public void test02CorrectlyFormattedZeroVenues() throws Exception {
     ...
     */
    @Test
    public void test03CorrectlyFormattedOneVenue() throws Exception {
        // string representations of the venues that we expect from the file
        List<String> expectedVenues = new ArrayList<>();
     ...
     */
    @Test
    public void test04CorrectlyFormattedManyVenues() throws Exception {
        // string representations of the venues that we expect from the file
        List<String> expectedVenues = new ArrayList<>();
     ...
     */
    @Test
    public void test05IncorrectlyFormattedCorridorTraffic() throws Exception {
        System.out.println("Expected: Error on line 4: traffic exceeds venue " +
                "capacity");
        try {
        ...
        System.out.println("Expected: Error on line 5: traffic exceeds " +
                "corridor capacity");
        try {
        ...
        System.out.println("Expected: Error on line 4: traffic is missing");
        try {
     ...
     */
    @Test
    public void test06IncorrectlyFormattedCorridor() throws Exception {
        System.out.println("Expected: Error on line 6: same corridor appears " +
        ...
        System.out.println("Expected: Error on line 4: incorrectly formatted " +
                "corridor - END is \"\" ");
        try {
     ...
     */
    @Test
    public void test07IncorrectlyFormattedVenueName() throws Exception {
        System.out.println("Expected: Error on line 6: venue name cannot be " +
                "\"\" ");
        try {
     ...
     */
    @Test
    public void test08IncorrectlyFormattedVenueCapacity() throws Exception {
        System.out.println("Expected: Error on line 7: venue capacity is " +
                "invalid");
        try {
     ...
     */
    @Test
    public void test09IncorrectlyFormattedVenueMissingEmptyLine()
            throws Exception {
        System.out.println("Expected: Error on line 9: empty line expected to" +
                " complete venue");
        try {
     ...
     */
    @Test
    public void test10IncorrectlyFormattedDuplicateVenues() throws Exception {
        System.out.println("Expected: Error found when line 10 reached: " +
     ...
     *
     * @param expectedVenueStrings A list of the expected string
     *                             representations of the venues
     *                             that should appear in actualVenues.
     * @param actualVenues         The list of venues to be checked against
     *                             expectedVenueStrings.
     */

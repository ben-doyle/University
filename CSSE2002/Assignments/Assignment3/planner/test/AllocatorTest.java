...
public class AllocatorTest {
    ...
    /**
     * Test Name: EmptyAllocationTest(
     * This test has one allocation, the empty set
     */
    @Test(timeout = 5000)
    public void TestEmptyAllocationTest() {
        ...
        Assert.assertEquals(null, Allocator.allocate(events, venues));
    }

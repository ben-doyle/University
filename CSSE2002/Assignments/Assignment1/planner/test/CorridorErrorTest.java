...
import planner.CorridorError;
import planner.Location;

/**
 * junit tests for the {@link CorridorError} implementation class.
 */
public class CorridorErrorTest {
    ...
    public void testBasicConstructor() {
        ...
        CorridorError c1 = new CorridorError(location1, location2, 100);
        c1.checkInvariant();
    }
    ...
    public void testNullArgumentException() {
        ...
        CorridorError corridor1 = new CorridorError(null, location1, 100);
        //Try to instantiate corridor with null end
        CorridorError corridor2 = new CorridorError(location1, null, 100);
        //Try to instantiate corridor with both null start/end
        CorridorError corridor3 = new CorridorError(null, null, 100);
    }
    ...
    public void testIlleagalArgumentException() {
        Location location1 = new Location("Alderly");
        CorridorError corridor1 = new CorridorError(location1, location1, 100);
    }
    ...
    public void testGetStart() {
        ...
        CorridorError corridor1 = new CorridorError(location1, location2, 100);
    ...
    public void testToString() {
        ...
        //Corridor Alderly to Bowen Hills (100)
        CorridorError c1 = new CorridorError(l1, l2, 100);
        String expected = "CorridorError Alderly to Bowen Hills (100)";
    ...
    public void testEquals() {
        ...
        CorridorError c1 = new CorridorError(l1, l2, 100);
        //Corridor Alderly to Bowen Hills (100)
        CorridorError c2 = new CorridorError(l1, l2, 100);
        //Corridor Bowen Hills to Alderly (100)
        CorridorError c3 = new CorridorError(l2, l1, 100);
    ...
    public void testHashCode() {
        ...
        CorridorError c1 = new CorridorError(location1, location2, 100);
        CorridorError c2 = new CorridorError(location1, location2, 100);
        CorridorError c3 = new CorridorError(location1, location2, 150);
    ...
    public void testCompareTo() {
        ...
        CorridorError c4 = new CorridorError(l1, l3, 100);
        //Corridor Alderly to Canon Hill (100)
        CorridorError c5 = new CorridorError(l1, l2, 100);
        //Corridor Alderly to Canon Hill (100)
        CorridorError c6 = new CorridorError(l1, l2, 150);

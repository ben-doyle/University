...
public class WordSet {
    ...
    /*
     * invariant: words != null && each element of words != null && no
     * duplicates in words
     */
     ...
     * 
     * @param word
     *            the word to be added to the set
     * @throws NullPointerException
     *             if the word to be added is null
     */
     ...
     * 
     * @param word
     *            the word to be removed from the set
     */
    ...
    public boolean checkInvariant() {
        if (words == null || nullElements() || duplicateElements()) {
            return false;
        }
        return true;
    }
    ...
    /**
     * Returns true if this WordSet has null elements, otherwise return false.
     * 
    ...
    /**
     * Returns true if this WordSet has duplicate elements, otherwise return
     * false.
     * 
